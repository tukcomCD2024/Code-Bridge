...
class PdfRendererView @JvmOverloads constructor(
    ...
    private var restoredScrollPosition: Int = RecyclerView.NO_POSITION
    ...
    private fun init(fileDescriptor: ParcelFileDescriptor) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            if (restoredScrollPosition != RecyclerView.NO_POSITION) {
                recyclerView.scrollToPosition(restoredScrollPosition)
                restoredScrollPosition = RecyclerView.NO_POSITION  // Reset after applying
            }
